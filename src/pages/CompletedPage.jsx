...
function AdditionalServices() {
  const services = [
    ...
    },
    {
      icon: 'fa-redo',
      title: '재작업 요청',
      description: '30일 이내 무료 재작업 가능',
    },
    {
      icon: 'fa-star',
      title: '리뷰 작성',
      description: '서비스 후기를 남겨주세요',
    },
  ];
              ...
              <div className="text-center">
                ...
                <div className="grid grid-cols-3 gap-6 mb-8">
                  <div className="text-center">
                    ...
                    <div className="text-lg text-neutral-900">3장</div>
                  </div>
                  <div className="text-center">
                    <div className="w-16 h-16 bg-neutral-100 rounded-full flex items-center justify-center mx-auto mb-3">
                    ...
                    <div className="text-lg text-neutral-900">2025.01.22</div>
                  </div>
                  <div className="text-center">
                    <div className="w-16 h-16 bg-neutral-100 rounded-full flex items-center justify-center mx-auto mb-3">
