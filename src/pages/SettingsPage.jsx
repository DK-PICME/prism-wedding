                      ...
                      <div className="space-y-3">
                        {currentUser?.providerData?.length ? (
                          currentUser.providerData.map((provider, idx) => {
                            ...
                            const canUnlink = currentUser.providerData.length > 1 && !isPrimary;
                            return (
                              <div key={provider.providerId + (provider.uid || idx)} className="flex items-center justify-between p-4 border border-neutral-200 rounded-lg">
                                ...
                                {canUnlink ? (
                                  <button className="px-3 py-1 text-sm border border-neutral-300 hover:bg-neutral-50 rounded text-neutral-700">연결 해제</button>
                                ) : (
